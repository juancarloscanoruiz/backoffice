                    ...
                    <div class="justify-content-around position-absolute d-flex p-5  div-promo">
                        ...
                        <label for="image-promo"
                            ...
                            <img src="{{ asset('/images/synopsis/camara.svg') }}" alt="add-photo"
                                class="add-photo  cursor-pointer " style="width:95px" />
                        ...
                        <label for="video-promo"
                            ...
                            <img src="{{ asset('/images/basic-icons/video.svg') }}" alt="add-photo"
                                class="add-photo  cursor-pointer " style="width:70px" />
                            <span class="a-text-bold-warm text-plus p-2 pr-3 pl-3 mr-4 white-shadow mt-3">Añade tu
                                archivo mp4 472px X 295px </span>
                            <video width="472" class="d-none" id="video-promo" controls>
                                <source src="" type="video/mp4"></video>
                        </label>

                        <label for="url-promo"
                            class="mb-0 cursor-pointer  d-flex justify-content-center align-items-center w-50   h-100 flex-column load-modales">
                            <a href="#url-promo" role="button" data-toggle="modal"> <img
                                    src="{{ asset('/images/basic-icons/link.svg') }}" alt="add-photo"
                                    class="add-photo  cursor-pointer  " style="width:70px" /></a>
