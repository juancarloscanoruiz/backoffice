            ...
            <div class="modal-body ">
                ...
                <div class="container-promo-cinema p-3 mt-4">
                    <div class="justify-content-around position-absolute d-flex input-promo-container align-items-center">
                        ...
                        <input type="file" name="" id="video-promo-file-concert" class="d-none file-video previewVideo" accept="video/*">
                ...
                <div class="text-center  mb-4 d-flex justify-content-center pb-2 mt-4">
                    <button id="btn-acepta-promo-cinema" class="upload-promo-button d-flex m-0  mr-3  btn-grilla a-btn-basic-small a-btn-basic-small text-uppercase a-text-MBlack text-plus" data-dismiss="modal">ACEPTAR</button>
