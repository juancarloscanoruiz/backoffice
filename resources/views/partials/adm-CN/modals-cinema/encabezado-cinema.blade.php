        ...
        <div class="modal-content align-item-center centro w-100 border-radius">
            <div class="modal-body">
                ...
                <div class="text-center  mb-3 d-flex justify-content-center pb-2 mt-4">
                    <button class="d-flex m-0  mr-3  btn-grilla a-btn-basic-small a-btn-basic-small text-uppercase a-text-MBlack text-plus" id="btn-acepta-modal-header-cinema">ACEPTAR</button>
