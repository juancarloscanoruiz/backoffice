<div class="modal modal-programming-carousel-cinema modal-programming-carousel-claro modal-programming-carousel pr-0"
    id="modaledi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true"
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="text-center mb-3 d-flex justify-content-center">
                    <button
                        class="d-flex mr-3 text-uppercase  m-0 btn-grilla a-btn-basic-small btn-grilla a-btn-basic-small text-uppercase a-text-MBlack text-plus banner-slider-button"
                        id="image-programming-button-cinema">aceptar</button>
