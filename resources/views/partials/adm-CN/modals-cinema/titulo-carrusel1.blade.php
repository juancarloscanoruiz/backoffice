  ...
  <div class="modal-dialog modal-lg modal-dialog-centered " role="document" >
    <div class="modal-content align-item-center centro w-100" >
      ...
      <div class="modal-body">
         ...
         <h2 class="h2 text-center a-text-black-brown-two pt-3">CARRUSEL 1 </h2>
         <hr class="d-flex align-content-center separationhr col-11 mt-3 mb-0">
         <div class="container-title-cinema mt-4 m-5">
             <div class="d-flex justify-content-around">
             <input type="text" name="links" id="hoy-channel"
                                            class="url-input p-4 pt-5 pb-5 h3 m-2  input-title-cinema  a-text-MBlack hoy-en text-uppercase" placeholder=" CARRUSEL 1" style="width:317px;" >
                                            <input type="text" name="links" id="LAS"
                                            class="url-input p-4 pt-5 pb-5 h3 m-2  input-title-cinema a-text-black-turquiose cinema-title-carrusel1-input text-uppercase" placeholder=" CARRUSEL 1" style="width:317px;">
