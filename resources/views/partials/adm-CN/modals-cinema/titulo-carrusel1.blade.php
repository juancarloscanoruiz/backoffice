      ...
      <div class="modal-body">
         ...
         <div class="container-title-cinema mt-4 m-5">
             ...
             <input type="text" name="links" id="hoy-channel"
                                            class="url-input p-4 pt-4 pb-4 h3 m-2 input-border input-title-cinema  a-text-MBlack hoy-en text-uppercase" placeholder=" CARRUSEL 1" style="width:317px;" >
                                            <input type="text" name="links" id="LAS"
                                            class="url-input p-4 pt-4 input-border pb-4 h3 m-2  input-title-cinema a-text-black-turquiose cinema-title-carrusel1-input text-uppercase" placeholder=" CARRUSEL 1" style="width:317px;">
         ...
         <div class="text-center  mb-3 d-flex justify-content-center pb-2 mt-4">
                            <button
                                class="d-flex m-0  mr-3  btn-landing opacity a-btn-basic-small text-uppercase a-text-MBlack text-plus edit-landing-modal-button"
