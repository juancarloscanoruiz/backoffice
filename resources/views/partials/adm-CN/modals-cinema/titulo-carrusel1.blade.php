                ...
                <div class="container-title-cinema mt-4 m-5">
                    <div class="d-flex justify-content-around">
                        <input type="text" name="links" id="hoy-channel"
                            class="url-input p-4 pt-4 pb-4 h3 m-2 input-carrusel1-title1-cinema input-border input-title-cinema  a-text-MBlack hoy-en text-uppercase"
                            placeholder="TÍTULO" style="width:317px;">
                        <input type="text" name="links" id="LAS"
                            class="url-input p-4 pt-4 input-border pb-4 h3 m-2 input-carrusel1-title2-cinema  input-title-cinema a-text-black-turquiose cinema-title-carrusel1-input text-uppercase"
                            placeholder="TÍTULO" style="width:317px;">
                    </div>
                    <div>

                        <input type="text" name="links" id="hoy-channel"
                            class="url-input p-3 input-carrusel1-subtitle-cinema container-width m-2  input-border input-title-cinema text-normal a-text-MBlack  pl-4 hoy-en text-uppercase"
