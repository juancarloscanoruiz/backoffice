                ...
                <div class="container-title-cinema mt-4 m-5">
                    <div class="d-flex justify-content-around">
                        <input type="text" name="links" id="hoy-channel"
                            class="url-input p-4 pt-4 pb-4 h3 m-2 input-border input-title-cinema  a-text-MBlack hoy-en text-uppercase modal-input-title1-cinema"
                            placeholder="LAS" style="width:317px;">
                        <input type="text" name="links" id="LAS"
                            class="url-input p-4 pt-4 pb-4 h3 m-2 modal-input-title2-cinema input-border  input-title-cinema a-text-black-yellow-two cinema-title-input text-uppercase"
                    ...
                    <div>
                        ...
                        <input type="text" name="links" id="hoy-channel"
                            class="url-input p-3 container-width m-2 modal-input-subtitle-cinema input-border input-title-cinema text-normal a-text-MBlack  pl-4 hoy-en text-uppercase"
