                                            ...
                                            <div>
                                                ...
                                                <div class="row">
                                                    <div class="col-6 mb-4">
                                                        <div class="text-center edit-rectangle-max-container py-1">
                                                            <p class="text-small-rectangle a-text-bold-warm">Inicio</p>
                                                            <img src="./images/calendario.svg" alt="" class="mr-3" style="margin-top: -7px;">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="text-center edit-rectangle-max-container py-1">
                                                            <p class="text-small-rectangle a-text-bold-warm">Inicio</p>
                                                            <img src="./images/reloj.svg" alt="" class="mr-3" style="margin-top: -7px;">
                                                            <span class="a-text-bold-warm">
                                                                <input key="" type="text" class="input-basic edit-program-input a-text-bold-warm schedule-date-input edit-schedule-date" placeholder="00-00-0000">
                                                            </span>
                                                        </div>
