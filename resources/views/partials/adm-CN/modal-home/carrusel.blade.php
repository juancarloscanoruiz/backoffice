<div id="modal-carrusel-home" class="modal" style="overflow: auto;">
    <div class="modal-dialog-centered modal-dialog max-width-modal-xl">
        <div class="modal-content modal-carrusel-home">
            ...
            <h2 class="h2 text-center a-text-black-brown-two pt-2 text-uppercase ">HOME - <span
                    class="changelanding text-uppercase">CANAL CLARO</span> - CARRUSEL PROMO</h2>
            <hr class="hr">
                        ...
                        <div class="row">
                            <div class="col-12 p-0">
                                ...
                                <div class="float-right">
                                    <div class="d-flex">
                                        <div
                                            class="position-relative slaider-docts slaider-home-dots carrusel1-slider-dots1 my-3">
                                        </div>
                            ...
                            <div class="col-12 p-0 mb-5">
                                ...
                                <section class="d-flex justify-content-between">
                                    <div class="col-5">
                                        ...
                                        <div
                                            class="state-container py-2 d-flex align-items-center justify-content-center">
                                    ...
                                    <div class="col-5">
                                        ...
                                        <div
                                            class="py-2 alert-container d-flex align-items-center justify-content-center">
                            ...
                            <div class="col-12">
                                ...
                                <div class="row carrusel-home-obj">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 edit-program-data-container">
                                                <div class="edit-data-container">
                                                    <p
                                                        class="mb-3 text-plus text-plus text-uppercase a-text-bold-coolgray float-left">
                                                        Estableceren landing</p>
                                                    <!--Switch-->
                                                    <div class="d-flex align-items-center mb-3 pl-5">
                                                        ...
                                                        <label for="yes-landing-carrusel1" id="siestado-landing"
                                                            class="mb-0 si-estilo cursor-pointer switch-label">Sí</label>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6 mb-4">
                                                                <div
                                                                    class="text-center edit-rectangle-max-container py-2 d-flex align-content-center justify-content-center">
                                                                    <p class="text-small-rectangle a-text-bold-warm">
                                                                        Inicio</p>
                                                            ...
                                                            <div class="col-6">
                                                                <div
                                                                    class="text-center edit-rectangle-max-container py-2 d-flex align-content-center justify-content-center">
                                                                    <p class="text-small-rectangle a-text-bold-warm">Fin
                                                                    </p>
                                                                    <img src="./images/calendario.svg" alt=""
                                                                        class="mr-3">
                                                                    <span class="a-text-bold-warm mt-3">
                                            ...
                                            <div class="col-6 edit-program-data-container">
                                                <div class="edit-data-container">
                                                    <p class="text-plus text-plus text-uppercase a-text-bold-coolgray"
                                                        style="margin-bottom: 72px;">Schedule Item Date time</p>
                                                    <div class="row">
                                                        <div class="col-6 mb-4">
                                                            <p
                                                                class="mb-3 text-plus a-text-medium-coolgray text-uppercase">
                                                                Fecha</p>
                                                            <div class="text-center edit-rectangle-max-container py-2 d-flex align-content-center justify-content-center"
                                                                style="margin-bottom: 99px">
                                                        ...
                                                        <div class="col-6">
                                                            <p
                                                                ...
                                                                Hora</p>
                                                            <div
                                                                class="text-center edit-rectangle-max-container d-flex align-content-center justify-content-center py-2">
                                                                <img src="./images/reloj.svg" alt="" class="mr-3">
                                                                <span class="a-text-bold-warm mt-2"><input type="text"
                                            ...
                                            <div class="col-6 mt-3">
                                                <div
                                                    class="edit-data-container d-flex justify-content-between m-schedule">
                                                    <p class="mb-0 text-plus text-uppercase a-text-bold-brown-two">
                                                        Schedule version <br> subbed</p>
                                                    <div class="d-flex">
                                                ...
                                                <div class="edit-data-container d-flex justify-content-between">
                                                    <p class="mb-0 text-plus text-uppercase a-text-bold-brown-two">Audio
                                                        5.1 available</p>
                                                    <div class="d-flex">
                                    ...
                                    <div class="col-4 p-0" id="img_carrusel_home">
                                        <div>
                                            ...
                                            <div class="position-relative text-center">
                                                <img class="img-back-modal img-carrusel-home" id="img-carrusel-home"
                                                    src="images/modals/back-large.svg">
                                            </div>
                                            <!-- BTN ICONOS -->
                                            <div class="modal-img-carrusel">
                                                ...
                                                <label for="img_carrusel" class="add-file load-programming-carousel">
                                                    <img id="camera" class="cursor-pointer mb-2"
                                                        src="./images/basic-icons/camara.svg" alt="add-photo" />
                                                    <br>
                                    ...
                                    <div class="offset-8 col-4 p-0">
                                        <span
                                            class="a-text-bold-brown-two text-plus my-4 d-block">NombreDeLaImagen_Home_Vertical_20200709.jpg</span>
                                    </div>
                                    <!-- SINOPSIS -->
                                    <div class="col-12">
                                        <section class=" edit-program-data-container">
                                            ...
                                            <button
                                                class="a-btn-teal a-btn-basic-small text-normal a-text-MBlack float-right btn-actual d-flex align-items-center justify-content-center"><img
                                                    src="./images/basic-icons/enter.svg" alt=""> ACTUALIZAR</button>
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-4 edit-program-data-container">
                                                <div class="edit-data-container">
                                                    <p class="mb-3 text-plus text-uppercase a-text-bold-brown-two">
                                                        Program episode season</p>
                                                    <div
                                            ...
                                            <!--Program genre list-->
                                            <div class="col-4 edit-program-data-container position-relative mt-3"
                                                id="edit-genre-container">
                                                <div class="edit-data-container">
                                                    <p class="mb-3 text-plus text-uppercase a-text-bold-brown-two">
                                                        Program genre list</p>
                                                    <div class="mb-3 edit-rectangle-container backwhite ">
                                                        <select
                                                            ...
                                                            data-header="Program List" data-dropup-auto="false"
                                                            key="genre">
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-4 edit-program-data-container mt-3">
                                                <div
                                                    ...
                                                    <p class="text-plus text-uppercase a-text-bold-brown-two">Schedule
                                                        item log date</p>
                                                    <p class="a-text-medium-brown-two text-plus text-uppercase">Fecha
                                                    </p>
                                                    <div
                                            ...
                                            <div class="col-4 edit-program-data-container mt-3">
                                                <div
                                                    ...
                                                    <p class="text-plus text-uppercase a-text-bold-brown-two pb-4">
                                                        Schedule item log time (gmt)</p>
