...
@section('content')
    <div class='bg-color'>
        <span class='d-flex align-items-center justify-content-between  py-xl-2'>
            <a href="{{ route('admin') }}"><span class='ml-5'><img src="{{ asset('/images/home/claro-logo.svg') }}">
                </span></a>
    ...
    <div class="ml-5 float-left">
        <div>
            <span class="a-text-black-light text-plus">Última edición : <span class="zona"> {{ $response['last_edition'] }}
                </span> </span>
        </div>
    ...
    <div class="mb-5 ml-5">
        <span
            class="text-plus a-text-bold-two mx-auto a-btn-white d-inline-block text-uppercase px-4 py-3">{{ $response['title'] }}</span>
    </div>
    ...
    <form action="{{ route('updateImages') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="bor mx-auto position-relative thumbnail-image-program"
                                ...
                                <label for="imageThumb-horizontal"
                                    ...
                                    <img src="{{ asset('/images/synopsis/camara.svg') }}" alt="add-photo"
                                        class="add-photo load-picture" />
                                    <span class="a-text-bold-warm text-plus mt-3">295px X 180px</span>
            ...
            <div class="centro position-relative mb-3">
                <div class="bor mx-auto position-relative thumbnail-image-program" id="thumbnail-home-horizontal">
                    <input type="file" name="image-horizontal" id="imageThumb-horizontal"
                        class="input-image-program d-none">
                    <label for="imageThumb-horizontal"
                        class="h-100 mb-0 d-flex justify-content-center align-items-center flex-column load-picture">
                        <img src="{{ asset('/images/basic-icons/pencil-edit-teal.svg') }}" alt="add-photo"
                            class="edit-image-icon cursor-pointer" />
                        <img src="{{ $response['thumbnail_list_horizontal'] }}" alt=""
                            class="image-cover thumbnail-image-program prev-image-program w-100 h-100">
                    </label>
                </div>
            </div>
            <div class="d-flex justify-content-center">
                ...
                <div class="d-flex justify-content-center">
                    <div class="centro mb-3">
                        <div class="bor position-relative mx-auto thumbnail-image-program" id="thumbnail-home-vertical">
                            <input type="file" name="image-vertical" id="imageThumb-vertical"
                                class="input-image-program d-none">
                            <label for="imageThumb-vertical"
                                class="mb-0 cursor-pointer d-flex justify-content-center align-items-center h-100 flex-column load-picture">
                                <img src="{{ asset('/images/synopsis/camara.svg') }}" alt="add-photo"
                                    class="add-photo cursor-pointer" />
                    ...
                    <div class="centro mb-3">
                        <div class="bor position-relative mx-auto thumbnail-image-program" id="thumbnail-home-vertical">
                            ...
                            <label for="imageThumb-vertical"
                                ...
                                <img src="{{ $response['thumbnail_list_vertical'] }}" alt=""
                                    class="w-100 h-100 thumbnail-image-program prev-image-program cursor-pointer image-cover">
                            </label>
                        </div>
                    </div>
                    <div class="d-flex justify-content-center">
            ...
            @else
                <div class="bor thumbnail-image-program position-relative h-100">
                    ...
                    <label for="image_background_1"
                        ...
                        <img src="{{ asset('/images/basic-icons/pencil-edit-teal.svg') }}" alt="add-photo"
                            class="edit-image-icon cursor-pointer" />
                        <img src="{{ $response['image_background_1'] }}"
                            class="w-100 h-100 cursor-pointer image-cover prev-image-program thumbnail-image-program" />
                    </label>
                </div>
            @endif
            ...
            @else
                <div class="bor thumbnail-image-program position-relative h-100">
                    ...
                    <label for="image_background_2"
                        ...
                        <img src="{{ asset('/images/basic-icons/pencil-edit-teal.svg') }}" alt="add-photo"
                            class="edit-image-icon cursor-pointer" />
                        <img src="{{ $response['image_background_2'] }}"
                            class="w-100 h-100 cursor-pointer image-cover prev-image-program thumbnail-image-program" />
                    </label>
                </div>
            @endif
            ...
            @else
                <div class="bor thumbnail-image-program position-relative h-100">
                    ...
                    <label for="image_background_3"
                        ...
                        <img src="{{ asset('/images/basic-icons/pencil-edit-teal.svg') }}" alt="add-photo"
                            class="edit-image-icon cursor-pointer" />
                        <img src="{{ $response['image_background_3'] }}"
                            class="w-100 h-100 cursor-pointer image-cover prev-image-program thumbnail-image-program" />
                    </label>
                </div>
            @endif
        ...
        @if (empty($response['image_synopsis']))
            <div class="ml-5 mb-5">
                <div class="bor mb-2 thumbnail-image-program position-relative" id="image_synopsis">
                    ...
                    <label for="imageThumb-synopsis"
                        class="mb-0 d-flex justify-content-center align-items-center h-100 flex-column load-picture">
            ...
            <div class="ml-5 mb-5">
                <div class="bor mb-2 thumbnail-image-program position-relative" id="image_synopsis">
                    ...
                    <label for="imageThumb-synopsis"
                        ...
                        <img src="{{ asset('/images/basic-icons/pencil-edit-teal.svg') }}" alt="add-photo"
                            class="edit-image-icon cursor-pointer" />
                        <img src="{{ $response['image_synopsis'] }}" alt=""
                            class="h-100 w-100 image-cover cursor-pointer prev-image-program thumbmail-image-program">
                    </label>
                </div>
                <span class="text-plus a-text-bold-brown-two"></span>
            </div>
        ...
        <div class="ml-5 no-gutters">
            <div class="d-flex no-gutters justify-content-around col-12 mb-5">
                @if (is_null($response['image_synopsis_frame_1']))
                    ...
                    <div class="col-4">
                        <div class="bor image-synopsis-frame thumbnail-image-program position-relative">
                            <input type="file" name="image-synopsis-1" id="imageThumb-synopsis-1"
                                class="input-image-program d-none">
                            <label for="imageThumb-synopsis-1"
                                class="mb-0 cursor-pointer d-flex justify-content-center align-items-center h-100 flex-column load-picture">
                                <img src="{{ asset('/images/synopsis/camara.svg') }}" alt="add-photo" class="add-photo" />
                ...
                @else
                    <div class="col-4">
                        <div class="bor thumbnail-image-program image-synopsis-frame position-relative mb-3">
                            <input type="file" name="image-synopsis-1" id="imageThumb-synopsis-1"
                                class="d-none input-image-program">
                            <label for="imageThumb-synopsis-1"
                                class="mb-0 d-flex justify-content-center align-items-center h-100 flex-column load-picture">
                                <img src="{{ asset('/images/basic-icons/pencil-edit-teal.svg') }}" alt="add-photo"
                                    class="edit-image-icon cursor-pointer" />
                                <img src="{{ $response['image_synopsis_frame_1'] }}" alt="add-photo"
                                    class="w-100 h-100 image-cover prev-image-program cursor-pointer thumbnail-image-program">
                            </label>
                        </div>
                        <span class="text-plus a-text-bold-brown-two "></span>
                    </div>
                ...
                @if (empty($response['image_synopsis_frame_2']))
                    <div class="col-4">
                        <div class="bor image-synopsis-frame thumbnail-image-program position-relative">
                            <input type="file" name="image-synopsis-2" id="imageThumb-synopsis-2"
                                class="input-image-program d-none">
                            <label for="imageThumb-synopsis-2"
                                class="mb-0 cursor-pointer d-flex justify-content-center align-items-center h-100 flex-column load-picture">
                                <img src="{{ asset('/images/synopsis/camara.svg') }}" alt="add-photo"
                                    class="add-photo cursor-pointer" />
                                <span class="a-text-bold-warm text-plus mt-3">375px X 215px</span>
                    ...
                    <div class="col-4">
                        <div class="mb-3 bor thumbnail-image-program image-synopsis-frame position-relative">
                            ...
                            <label for="imageThumb-synopsis-2"
                                ...
                                <img src="{{ asset('/images/basic-icons/pencil-edit-teal.svg') }}" alt="add-photo"
                                    class="edit-image-icon cursor-pointer" />
                                <img src="{{ $response['image_synopsis_frame_2'] }}" alt="add-photo"
                                    class="w-100 h-100 prev-image-program cursor-pointer image-cover thumbnail-image-program">
                            </label>
                        </div>
                ...
                @if (empty($response['image_synopsis_frame_3']))
                    <div class="col-4">
                        <div class="bor image-synopsis-frame thumbnail-image-program position-relative">
                            <input type="file" name="image-synopsis-3" id="imageThumb-synopsis-3"
                                class="input-image-program d-none">
                            <label for="imageThumb-synopsis-3"
                                class="mb-0 cursor-pointer d-flex justify-content-center align-items-center h-100 flex-column load-picture">
                                <img src="{{ asset('/images/synopsis/camara.svg') }}" alt="add-photo"
                                    class="add-photo cursor-pointer" />
                                <span class="a-text-bold-warm text-plus mt-3">375px X 215px</span>
                    ...
                    <div class="col-4">
                        <div class="mb-3 bor thumbnail-image-program image-synopsis-frame position-relative">
                            ...
                            <label for="imageThumb-synopsis-3"
                                ...
                                <img src="{{ asset('/images/basic-icons/pencil-edit-teal.svg') }}" alt="add-photo"
                                    class="edit-image-icon cursor-pointer" />
                                <img src="{{ $response['image_synopsis_frame_3'] }}" alt="add-photo"
                                    class="w-100 h-100 cursor-pointer image-cover thumbnail-image-program prev-image-program">
                            </label>
                        </div>
                        <span class="text-plus a-text-bold-brown-two "></span>
                    </div>
        ...
        <div class="d-flex justify-content-center mb-5">
            <input type="submit"
                class="text-uppercase d-flex justify-content-center a-btn-basic-medium a-btn-teal a-text-bold-white text-normal load-picture"
                value="Guardar">
        </div>
    </form>
@endsection
