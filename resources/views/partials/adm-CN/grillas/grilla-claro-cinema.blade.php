    ...
    <div id="bodymenu">
        <div id="grilla">
            ...
            @if (count($respuesta->data->programs)!=0)
                <input disabled id="inp_programing_claro_cinema" type="file" >
                <label onclick="subirArchivos()" for="inp_programing_claro_cinema" class="btn-cargar pl-2" style="display: flex; align-items:center;position: absolute;padding-left:.2rem"><span class="  text-crea"><img src="./images/clip.svg" alt="" class=" mr-2">Cargar archivos</span></label>

            @else
                <input id="inp_programing_claro_cinema" type="file" >
                <label for="inp_programing_claro_cinema" class="btn-cargar pl-2" style="display: flex; align-items:center;position: absolute;padding-left:.2rem"><span class="  text-crea"><img src="./images/clip.svg" alt="" class=" mr-2">Cargar archivos</span></label>
