...
<div id="bodymenu">
    <div id="grilla">
                                ...
                                @if ($programs[$indexPrograms]->in_landing == 0)
                                    ...
                                    <div class="establecer-options pointer-none">
                                        <div class=" d-flex mt-2 ml-2 pt-2">
                                            ...
                                            <span class="text-left cursor-pointer a-text-medium-warmgrey ml-2">Recordar es volver a vivir</span>
                                        </div>
                                        <div class="d-flex ml-2 pt-2 pb-2">
                                            ...
                                            <span class="text-left cursor-pointer a-text-medium-warmgrey ml-2">Sexy románticas</span>
                                        </div>
                                    </div>
                                @else
                                    <div class='yes-no mt-3'>
                                    ...
                                    @if ($programs[$indexPrograms]->in_landing == 1)
                                        <div class="establecer-options">
                                            <div class=" d-flex mt-2 ml-2 pt-2">
                                                ...
                                                <span class="text-left cursor-pointer a-text-medium-brownish ml-2">Recordar es volver a vivir</span>
                                            </div>
                                            <div class="d-flex ml-2 pt-2 pb-2">
                                                <label class="checkradio d-flex ml-2">
                                                ...
                                                <span class="text-left cursor-pointer a-text-medium-brownish ml-2">Sexy románticas</span>
                                            </div>
                                        </div>
                                    @else
                                        <div class="establecer-options">
        ...
        <div class="contenedor mb-5 ml-5 pr-5">
            <div class="contenedor-columna centro">
                <div id="agregar-claro-cinema" class="d-flex align-items-center a-btn-basic-large a-btn-teal signo justify-content-center  ml-2">
