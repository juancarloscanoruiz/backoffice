        ...
        <div id="rempla-claro-canal" class="landing-table table-porcent">
            <div id="tb1" class="ml-5 pr-5 conten-tab">
                <div class="mr-5 grilla-body position-relative">
                    ...
                    @else
                    @for ($indexGrill = 0; $indexGrill < count($grill); $indexGrill++) <?php $programs = $grill[$indexGrill]->programs; ?> @for ($indexPrograms=0; $indexPrograms < count($programs); $indexPrograms++) <div class="contenedor-fila" id="programacion-claro-{{ $programs[$indexPrograms]->chapter_id }}">
                        <!--ACCIONES-->
                        ...
                        <div class="contenedor-columna selectable-column centro editable-column" rel="establecer-landing" chapter_id="{{ $programs[$indexPrograms]->chapter_id }}" key="in_landing">
                            ...
                            <div class="establecer-options pointer-none">
                                <div class=" d-flex mt-2 ml-2 pt-2">
                                    <label class="checkradio d-flex ml-2" for="landing-section-1-{{ $programs[$indexPrograms]->chapter_id }}">
                            ...
                            <div class="establecer-options">
                                <div class=" d-flex mt-2 ml-2 pt-2">
                                    ...
                                    <span class="cursor-pointer a-text-medium-brownish ml-2">Carrusel
                                        1</span>
                                </div>
                                <div class="d-flex ml-2 pt-2 pb-2">
                                    <label class="checkradio d-flex ml-2" for="landing-section-2-{{ $programs[$indexPrograms]->chapter_id }}">
                        ...
                        <div class="contenedor-columna centro editable-column" rel="schedule-item-date-time">
                            <div class="schedule-date">
                                <label class='a-text-medium-brownish d-flex justify-content-center  pb-2' type=date>{{ $day . '-' . $month . '-' . $year }}</label> <label class='a-text-medium-brownish d-flex justify-content-center' type='time' style='line-height:0px;'>{{ $programs[$indexPrograms]->programing }}
                                    HRS</label>
                            </div>
                        </div>
                            ...
                            <div class="schedule-date">
                                <div class="d-flex justify-content-center">
                                    ...
                                    <select class="selectpicker dropup a-text-regular-brownishtwo text-normal show-tick" title="{{ $genre }}" multiple data-live-search="true" data-live-search-placeholder="Buscar" data-header="Program List" data-dropup-auto="false">
                                        @for ($i = 0; $i < count($genres); $i++) <option class="a-text-regular-brownishtwo text-normal" value="{{ $genres[$i]->title }}">{{ $genres[$i]->title }}
                                            </option>
                                            @endfor
                                    </select>
                                </div>
