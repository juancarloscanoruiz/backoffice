...
<div class="grilla-concert-channel">
    ...
    <div class="d-flex float-right mt-2 ml-btn mb-5  mr-5 ">
        <button class="btn-grilla  text-grilla mr-3 gril-concert" id="btn-grilla" ><span>Grilla</span></button>
        <button class="btn-landing  text-landing lan-concert" id="btn-landing" ><span>Landing</span></button>
    </div>
