<body class="">
    ...
    <div id="modal-header" class="modal">
        <div class="modal-dialog-centered">
            <div class="modal-header-claro">
                <!-- TEXTO -->
                <p class="text-normal d-flex ml-3 text-center a-text-black-brown-two pt-3">CARGAR IMAGENES EN FORMATO
                    PNG</p>
                        ...
                        <div class="content-img-modal">
                            <label for="img-header">
                                <div id="img-header-claro">
                                    <img src="/images/modals/img-header.png" alt="">
                                </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 100%">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <h3 class="h3 a-text-semibold-brownish-grey-three text-uppercase mb-4 mt-5" id="slider-calendar-current-date">SEPTIEMBRE 2020</h3>
    ...
    <div id="modal-carrusel1" class="modal">
        <div class="modal-carrusel-claro modal-content">
            <!-- TITULO  -->
            <div id="num_carrusel">
            </div>
            <hr class="hr">

            <div class="contet-carrusel-modal">
                <!-- DOTS -->
                    ...
                    <div class="float-right">
                        <ul class="slick-dots" role="tablist">
                            ...
                            <li role="presentation">
                                <p class="a-text-bold-teal slider-pagination-item">2</p>
                            </li>
                            <li role="presentation">
                                <p class="a-text-bold-teal slider-pagination-item">3</p>
                            </li>
                            <li role="presentation">
                                <p class="a-text-bold-teal slider-pagination-item">4</p>
                            </li>
                            <img src="/images/add-icon.svg" class="add-programming-image cursor-pointer mr-2">
                        </ul>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="row" id="status-carrusel1">
                            <!-- <div class="col-5">
                                ...
                                <div class="state-container py-2 d-flex align-items-center justify-content-center">
                                    ...
                                    <p class="mb-0 ml-3 a-text-bold-teal">En edicion</p>
                                </div>
                            </div>
                            <div class="col-5 offset-2">
                                ...
                                <div class="py-2 alert-container d-flex align-items-center justify-content-center">
                                    ...
                                    <p class="mb-0 ml-3 a-text-bold-orange">Información completa</p>
                                </div>
                            </div> -->
                        </div>
                    </div>
                ...
                <!-- SELECT E IMGAEN -->
                <select class="slt-carrusel1-modal" name="carrusel1-titulo-programa" id="carrusel1-titulo-programa">
                </select>
                <!-- IMG -->
                <div class="position-relative text-center" id="back-carrusel1-claro">
                    <img src="images/heart-icon.svg" class="heart-icon-carrusel" alt="heart-icon" />
                </div>
                <!-- BTN ICONOS -->
                <div class="img-carrusel-claro text-center">
                    <!-- INPUTS -->
                    <input class="d-none" id="carrusel1-claro-img" name="img-carrusel-claro" type="file">
                    <!-- LABEL -->
                    <label for="carrusel1-claro-img" class="add-file">
                        <img class="cursor-pointer mb-2" src="images/modals/camara.svg" alt="add-photo" style="width: 100px;" />
                ...
                <section class="mb-5">
                    <div class="row">
                        ...
                        <div class="col-4 edit-program-data-container edit-data-container-large">
                            <div class="edit-data-container h-100">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <label for="yes-landing-carrusel1" id="siestado-landing" class="mb-0 si-estilo cursor-pointer switch-label">
                                        Sí</label>
                                    <input type="radio" id="no-landing-carrusel1" value="0" class="edit-switch-landing switch-table-edit edit-landing-no" checked />
                                    <label for="no-landing-carrusel1" id="noestado-landing" class="mb-0 no-estilo cursor-pointer switch-label">
                                        No</label>
                                </div>
                                <div class="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    ...
                                    <div class="mb-3 text-center edit-rectangle-small-container backwhite py-3">
                                        <span class="a-text-bold-warm">Inicio: <input id="inicio-programing-landing" type="text" class="input-basic edit-program-input a-text-bold-warm edit-program-attribute-text schedule-date-input edit-landing-date-begin" placeholder="00-00-0000" key="in_landing_begin" /></span>
                                    </div>
                                    <div class="mb-4 text-center edit-rectangle-small-container  backwhite py-3">
                                        <span class="a-text-bold-warm">Fin: <input id="fin-programing-landing" type="text" class="input-basic edit-program-input a-text-bold-warm edit-program-attribute-text schedule-date-input edit-landing-date-end" key="in_landing_expiration" placeholder="00-00-0000"></span>
                                    </div>
                                </div>
                        ...
                        <div class="col-4 edit-program-data-container edit-data-container-large">
                            <div class="edit-data-container h-100">
                                <p class="mb-3 text-plus text-plus text-uppercase a-text-bold-coolgray">Establecer en
                                    home</p>
                                <!-- SWITCH -->
                                ...
                                <div>
                                    <p class="mb-3 text-plus a-text-medium-coolgray text-uppercase">Fecha</p>
                                    <div class="mb-3 text-center edit-rectangle-small-container backwhite py-3">
                                        <span class="a-text-bold-warm">Inicio: <input id="inicio-programing-home" key="in_home_begin" type="text" class="input-basic edit-program-input a-text-bold-warm schedule-date-input edit-home-date-begin edit-program-attribute-text" placeholder="00-00-0000" /></span>
                                    </div>
                                    <div class="mb-4 text-center edit-rectangle-small-container  backwhite py-3">
                                        <span class="a-text-bold-warm">Fin: <input id="fin-programing-home" type="text" key="in_home_expiration" class="input-basic edit-program-input a-text-bold-warm schedule-date-input edit-home-date-end edit-program-attribute-text" placeholder="00-00-0000"></span>
                                    </div>
                                </div>
                                <p class="mb-3 text-plus a-text-medium-coolgray text-uppercase">Hora</p>
                                <div class="mb-3 text-center edit-rectangle-small-container backwhite py-3">
                        ...
                        <div class="col-4 edit-program-data-container edit-data-container-large">
                            <div class="edit-data-container h-100">
                                ...
                                <div>
                                    <p class="mb-3 text-plus a-text-medium-coolgray text-uppercase">Fecha</p>
                                    <div class="text-center edit-rectangle-small-container py-2 d-flex align-content-center  backwhite justify-content-center" style="margin-bottom: 81px">
                                        <img src="images/calendario.svg" alt="" class="mr-3">
                                        <input key="" type=" text" class="input-basic edit-program-input a-text-bold-warm schedule-date-input edit-schedule-date" placeholder="00-00-0000">
                                    </div>
                                </div>
                                <p class="mb-3 pt-3 text-plus a-text-medium-coolgray text-uppercase">Hora</p>
                                <div class="text-center edit-rectangle-small-container d-flex align-content-center  backwhite justify-content-center py-2">
                                    <img src="images/reloj.svg'" alt="" class="mr-3">
                                    <input type="text" class="time-seconds-input input-basic edit-program-input a-text-bold-warm edit-schedule-item-time text-uppercase" placeholder="00:00:00">
                                </div>
                            </div>
                        </div> 
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 edit-program-data-container">
                            <div class="edit-data-container">
                                ...
                                <div class="mb-3 text-center edit-rectangle-small-container backwhite py-3">
                                    <input id="season-input" type="text" key="season" class="edit-program-season text-center input-basic edit-program-input edit-program-attribute-text a-text-bold-warm text-uppercase" placeholder="00">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-4 edit-program-data-container">
                            <div class="edit-data-container">
                                ...
                                <div class="mb-3 text-center edit-rectangle-small-container backwhite py-3">
                                    <input id="episode-input" type="text" key="program_episode_number" class="text-center edit-episode-number input-basic edit-program-input edit-program-attribute-text a-text-bold-warm text-uppercase" placeholder="000">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-4 edit-program-data-container">
                            <div class="edit-data-container">
                                ...
                                <div class="mb-3 text-center edit-rectangle-small-container backwhite py-3">
                                    <input id="year-input" type="text" key="program_year_produced" class="year-input text-center edit-year-produced input-basic edit-program-attribute-text edit-program-input a-text-bold-warm text-uppercase" placeholder="YYYY">
                                </div>
                            </div>
                        </div> 
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 edit-program-data-container">
                            <div class="edit-data-container">
                                ...
                                <div class="mb-3 text-center edit-rectangle-small-container backwhite py-3">
                                    <input id="rating-input" type="text" key="rating" class="text-center edit-program-attribute-text input-basic edit-program-input a-text-bold-warm text-uppercase edit-rating-code" placeholder="PG-00">
                                </div>
                            </div>
                        </div> 
                    </div>
                        ...
                        <div class="col-4 edit-program-data-container">
                            <div class="edit-data-container d-flex flex-column justify-content-between h-100">
                                ...
                                <div>
                                    ...
                                    <div class="mb-3 text-center edit-rectangle-small-container py-3 d-flex align-items-center backwhite justify-content-center">
                                        <img src="images/calendario.svg" alt="" class="mr-3">
                        ...
                        <div class="col-4 edit-program-data-container">
                            <div class="edit-data-container d-flex flex-column justify-content-between h-100">
                                ...
                                <div>
                                    ...
                                    <div class="mb-3 text-center edit-rectangle-small-container py-3 d-flex align-items-center  backwhite justify-content-center">
                                        <img src="images/reloj.svg" alt="" class="mr-3">
                                        <input id="duracion-input" type="text" key="duration" class="edit-program-duration edit-program-attribute-text time-seconds-input input-basic edit-program-input a-text-bold-warm text-uppercase" placeholder="00:00:00">
                                    </div>
                                </div>
            ...
            <div class="m-auto btn-modal-progra">
    ...
    <!-- CARRUSEL BUENO -->
    <div class="modal pr-0 fade modal-edit-program" id="modaledi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true" style="overflow: auto;">
                ...
                <div class="modal-body pt-0">
                    ...
                    <div class="col-11 mx-auto">
                        ...
                        <section class="thermometer mb-4">
                            <div class="thermometer-hours-container mt-4">
                                <ul class="thermometer-hours-list d-flex pr-3 pl-3">
                                    <li class="thermometer-hours-item mr-1 text-center text-plus a-text-black-brown-two">
                                        0
                                    </li>
                                    <li class="thermometer-hours-item mr-1 text-center text-plus a-text-black-brown-two">
                                        1
                            ...
                            <div class="position-relative mt-4">
                                <img src="{{ asset('/images/arrow-dark.svg') }}" class="arrow-thermometer arrow-thermometer-left" alt="arrow-left">
                                <div class="thermometer-container">
                                    <ul class="thermometer-schedule-list d-flex p-3">

                                    </ul>
                                </div>
                                <img src="{{ asset('/images/arrow-dark.svg') }}" class="arrow-thermometer arrow-thermometer-right" alt="arrow-right">
                            </div>
                        </section>
                        ...
                        <div class="edit-info-container">
                            ...
                            <section class="edit-program-image">
                                <select class="thumbnail-header1 thumbnail-header thumbnail-header-claro w-100 a-text-MBlack h2 d-flex align-items-center justify-content-between position-relative programs-catalogue" title="TÍTULO DEL PROGRAMA" id="prog_titulo_programa" data-live-search="true" data-live-search-placeholder="Agregar título de nuevo programa" name="thumbnail-header1" key="title">
                                </select>
                                <!--Imagen del programa--->
                                <div class="edit-thumbnail position-relative">
                                    ...
                                    <label for="edit-image-horizontal" class="load-modal-programming load-photo d-inline" id="imagenes">
                                        <img src="{{ asset('/images/heart-icon.svg') }}" class="thumbnail-heart-icon" alt="heart-icon" />
                                        ...
                                        <img src="{{ asset('/images/synopsis/image-synopsis-carrusel.jpg') }}" alt="" class="thumbnail-image-prev edit-image-program prev-image-program" />
                                    </label>
                                </div>
                                <!--Nombre de la imagen-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4 edit-program-data-container edit-data-container-large">
                                        <div class="edit-data-container h-100">
                                            ...
                                            <!--Switch-->
                                            <div class="d-flex align-items-center mb-3">
                                                <input type="radio" name="sino-landing" id="yes-landing" value="3" class="edit-switch-landing edit-landing-yes" key="in_landing" />
                                                <label for="yes-landing" id="siestado-landing" class="mb-0 si-estilo cursor-pointer switch-label">
                                                    Sí</label>
                                                <input type="radio" name="sino-landing" id="no-landing" value="0" class="edit-switch-landing switch-table-edit edit-landing-no" key="in_landing" />
                                            ...
                                            <div class="d-flex align-items-center mb-3">
                                                <label class="checkradio d-flex ml-2 mb-0" for="landing-section-1">
                                                    <input type="radio" disabled name="dontlose" class="switch-table-edit edit-carrusel-1" value="1" id="landing-section-1" key="in_landing" />
                                                    <span class="checkmark"></span>
                                                </label>
                                                <span class="a-text-bold-silver cursor-pointer ml-2 text-uppercase">Carrusel
                                                    1</span>
                                                <label class="checkradio d-flex ml-2 mb-0" for="landing-section-2">
                                                    <input type="radio" disabled name="dontlose" class="mb-0 switch-table-edit edit-carrusel-2" value="2" id="landing-section-2" key="in_landing" />
                                                    <span class="checkmark"></span>
                                                </label>
                                    ...
                                    <div class="col-4 edit-program-data-container edit-data-container-large">
                                        <div class="edit-data-container h-100">
                                            ...
                                            <!--Switch-->
                                            <div class="d-flex align-items-center edit-switches-home-container">
                                                <input type="radio" name="sino-home" id="edit-in-home-yes" value="1" class="edit-switch-home edit-program-switch edit-in-home-yes" key="in_home" />
                                                <label for="edit-in-home-yes" id="siestado-landing" class="si-estilo cursor-pointer mb-0 switch-label">
                                                    Sí</label>
                                                <input type="radio" name="sino-home" id="edit-in-home-no" value="0" checked class="edit-switch-home edit-program-switch edit-in-home-no" key="in_home" />
                                                <label for="edit-in-home-no" id="noestado-landing" class="mb-0 no-estilo cursor-pointer switch-label">
                                                    No</label>
                                            </div>
                                            <div>
                                                <p class="mb-3 text-plus a-text-medium-coolgray text-uppercase">Fecha
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4 edit-program-data-container">
                                        <div class="edit-data-container d-flex justify-content-between">
                                            ...
                                            <div class="d-flex">
                                                <input type="radio" name="subbed" id="yes-subbed" value="1" class="edit-program-switch switch-landing edit-subbed-yes" key="subbed" />
                                                <label for="yes-subbed" id="siestado-landing" class="si-estilo cursor-pointer mb-0 switch-label">
                                                    Sí</label>
                                                <input type="radio" name="subbed" id="no-dubbed" value="0" checked class="edit-program-switch switch-landing switch-table-edit edit-subbed-no" key="subbed" />
                                                <label for="no-dubbed" id="noestado-landing" class="mb-0 no-estilo cursor-pointer switch-label">
                                                    No</label>
                                            </div>
                                    ...
                                    <div class="col-4 edit-program-data-container">
                                        <div class="edit-data-container d-flex justify-content-between">
                                            ...
                                            <div class="d-flex">
                                                <input type="radio" name="dubbed" id="yes-dubbed" value="1" class="edit-program-switch switch-landing edit-dubbed-yes" key="dubbed" />
                                                <label for="yes-dubbed" id="siestado-landing" class="si-estilo cursor-pointer mb-0 switch-label">
                                                    Sí</label>
                                                <input type="radio" name="dubbed" id="no-dubbed" value="0" checked class="edit-program-switch switch-landing switch-table-edit edit-dubbed-no" key="dubbed" />
                                                <label for="no-dubbed" id="noestado-landing" class="mb-0 no-estilo cursor-pointer switch-label">
                                                    No</label>
                                            </div>
                                    ...
                                    <div class="col-4 edit-program-data-container">
                                        <div class="edit-data-container d-flex justify-content-between">
                                            ...
                                            <div class="d-flex">
                                                <input type="radio" name="audio5" id="yes-audio5" value="1" class="edit-program-switch switch-landing edit-audio5-yes" key="audio5" />
                                                <label for="yes-audio5" id="siestado-landing" class="si-estilo cursor-pointer mb-0 switch-label">
                                                    Sí</label>
                                                <input type="radio" name="audio5" id="no-audio5" value="0" checked class="edit-program-switch switch-landing switch-table-edit edit-audio5-no" key="audio5" />
                                                <label for="no-audio5" id="noestado-landing" class="mb-0 no-estilo cursor-pointer switch-label">
                                                    No</label>
                                            </div>
                    ...
                    <div class=" d-flex justify-content-center">
                        <section class="text-center mb-3 d-flex justify-content-center">
                            <button class="d-flex  mr-3  m-0 text-uppercase btn-grilla a-btn-basic-small btn-grilla a-btn-basic-small text-uppercase a-text-MBlack text-plus edit-landing-modal-button" data-dismiss="modal" id="edit-program-modal-button">ACEPTAR</button>
                        </section>
                                ...
                                <div class="centro position-relative logo-lading-container mb-3">
                                    <div class="bor mx-auto position-relative thumbnail-image-program" id="thumbnail-home-horizontal">
                                        ...
                                        <label for="image-icon1" class="mb-0 cursor-pointer  d-flex justify-content-center align-items-center h-100 flex-column load-modales">
                                            ...
                                            <span class="a-text-bold-warm text-plus p-2 pr-3 pl-3  white-shadow" style="z-index:10000">86px X 18px</span>
                                ...
                                <div class="centro position-relative mb-3 logo-lading-container">
                                    <div class="bor mx-auto position-relative thumbnail-image-program" id="thumbnail-home-horizontal">
                                        ...
                                        <label for="image-icon2" class="mb-0 cursor-pointer d-flex justify-content-center align-items-center h-100 flex-column load-modales">
                                            <img src="{{ asset('/images/synopsis/camara.svg') }}" alt="add-photo" class="add-photo " style="z-index:10000" />
                                            <span class="a-text-bold-warm text-plus p-2 pr-3 pl-3  white-shadow" style="z-index:10000">48px X 53px</span>
                                ...
                                <div class="centro position-relative mb-3 logo-lading-container">
                                    <div class="bor mx-auto position-relative thumbnail-image-program" id="thumbnail-home-horizontal">
                                        ...
                                        <label for="image-icon3" class="mb-0 cursor-pointer d-flex justify-content-center align-items-center h-100 flex-column load-modales">
                                            <img src="{{ asset('/images/synopsis/camara.svg') }}" alt="add-photo" class="add-photo " style="z-index:10000" />
                                            <span class="a-text-bold-warm text-plus p-2 pr-3 pl-3  white-shadow" style="z-index:10000">40px X 40px</span>
