...
<body class="bg-dark">
    ...
    <div id="modal-carrusel1" class="modal">
        <div class="modal-carrusel-claro modal-content">
            <!-- TITULO  -->
            <h2 class="a-text-black-brown-two text-center">PROGRAMACIÓN PRINCIPAL - CARRUSEL 1</h2>
            <hr class="hr">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 100%">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <!--Slider de calendario-->
                    <h3 class="h3 a-text-semibold-brownish-grey-three text-uppercase mb-4 mt-5" id="slider-calendar-current-date">Octubre 2020</h3>
