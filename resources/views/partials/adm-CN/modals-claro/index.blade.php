            ...
            <div class="modal-header-claro">
                ...
                <div class="content-item-center">
                    ...
                    <div class="inp-content ">
                        <input class="inp-text-modal-1 h2 ml-3 a-text-black-brown-two  hoy-en-cinema text-uppercase"
                            type="text" placeholder="HOY EN">
                    </div>
                    <!-- CANAL CLARO -->
                    <div class="inp-content ">
                        <input
                            class="inp-text-modal-2 h2 a-text-black-tomato ml-3 cinema-input-title mr-3 text-uppercase"
                            type="text" placeholder="CANAL CLARO">
                    </div>
                    <!-- VER PROGRAMACIÓN -->
        ...
        <div class="modal-dialog-centered modal-dialog modal-lg">
            <div class="modal-title-claro modal-content">
                ...
                <div class="title-modal-content">
                    ...
                    <input id="inp-sub-title-modal"
                        class="inp-sub-title-modal text-uppercase a-text-bold-white  text-normal" type="text">
                </div>
                <!-- BOTONES -->
                <div class="content">
                    <div class="d-flex justify-content-center mt-3">
                    ...
                    <div class="row">
                            ...
                            <div class="edit-data-container h-100">
                                ...
                                <div>
                                    ...
                                    <div class="mb-4 text-center edit-rectangle-small-container  backwhite py-3">
                                        <span class="a-text-bold-warm">Fin: <input id="fin-programing-landing"
                                                type="text"
                        ...
                        <div class="col-4 edit-program-data-container edit-data-container-large">
                            <div class="edit-data-container h-100">
                                ...
                                <div>
                                    <p class="mb-3 text-plus a-text-medium-coolgray text-uppercase">Fecha</p>
                                    <div class="text-center edit-rectangle-small-container py-2 d-flex align-content-center  backwhite justify-content-center"
                                ...
                                <div
                                    class="text-center edit-rectangle-small-container d-flex align-content-center  backwhite justify-content-center py-2">
                        ...
                        <div class="col-4 edit-program-data-container">
                            <div class="edit-data-container d-flex flex-column justify-content-between h-100">
                                ...
                                <div>
                                    ...
                                    <div
                                        class="mb-3 text-center edit-rectangle-small-container py-3 d-flex align-items-center backwhite justify-content-center">
                                        <img src="images/calendario.svg" alt="" class="mr-3">
                ...
                <div class="modal-body pt-0">
                    ...
                    <div class="col-11 mx-auto">
                        ...
                        <section class="col-8 mx-auto">
                            <h3 class="h3 a-text-semibold-brownish-grey-three text-uppercase mesinfo mb-5 mt-6"
                                id="slider-calendar-current-date">SEPTIEMBRE 2020</h3>
                        ...
                        <div class="edit-info-container">
                                    ...
                                    <div class="col-4 edit-program-data-container edit-data-container-large">
                                        <div class="edit-data-container h-100">
                                            ...
                                            <div>
                                                ...
                                                <div
                                                    class="mb-3 text-center edit-rectangle-small-container backwhite py-2 align-items-center">
                                                ...
                                                <div
                                                    class="mb-4 text-center edit-rectangle-small-container backwhite py-2 align-items-center">
                                                    <img src="{{ asset('images/calendario.svg') }}" alt=""
                                                        class="mr-3"><span class="a-text-bold-warm pr-2">Fin: <input
                                                            type="text"
                                                            class="input-basic edit-program-input a-text-bold-warm edit-program-attribute-text schedule-date-input edit-landing-date-end"
                                                            key="in_landing_expiration" placeholder="00-00-0000"></span>
                                                </div>
                                            ...
                                            <div
                                                class="mb-3 text-center edit-rectangle-small-container backwhite py-2 align-items-center">
                                                <img src="{{ asset('images/reloj.svg') }}" alt="" class="mr-2"> <span
                                                    class="a-text-bold-warm">Inicio: <input type="text"
                                                        class="time-seconds-input input-basic edit-program-input edit-program-attribute-text a-text-bold-warm text-uppercase edit-landing-time-begin"
                                                        key="in_landing_begin" placeholder="00:00:00"></span>
                                            </div>
                                            <div
                                                class="text-center edit-rectangle-small-container  backwhite py-2 align-items-center">
                                                <img src="{{ asset('images/reloj.svg') }}" alt="" class="mr-3"> <span
                                                    class="a-text-bold-warm pr-2">Fin: <input type="text"
                                                        class="time-seconds-input input-basic edit-program-input edit-program-attribute-text a-text-bold-warm text-uppercase edit-landing-time-end"
                                                        key="in_landing_expiration" placeholder="00:00:00"></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-4 edit-program-data-container edit-data-container-large">
                                        <div class="edit-data-container h-100">
                                            ...
                                            <div
                                                class="mb-3 text-center edit-rectangle-small-container backwhite py-2 align-items-center">
                                                <img src="{{ asset('images/reloj.svg') }}" alt="" class="mr-2"> <span
                                                    class="a-text-bold-warm">Inicio: <input key="in_home_begin"
                                                        type="text"
                                                        class="time-seconds-input input-basic edit-program-input a-text-bold-warm text-uppercase edit-home-time-begin"
                                                        placeholder="00:00:00"></span>
                                            </div>
                                    ...
                                    <div class="col-4 edit-program-data-container edit-data-container-large">
                                        <div class="edit-data-container h-100">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-center edit-rectangle-small-container  backwhite py-2 d-flex align-content-center justify-content-center align-items-center"
                                                    style="margin-bottom: 81px">
                                            ...
                                            <div
                                                class="text-center edit-rectangle-small-container d-flex backwhite align-content-center justify-content-center py-2 align-items-center">
                                                <span class="a-text-bold-warm"><img
                                                        src="{{ asset('images/reloj.svg') }}" alt="" class="mr-2"><input
                                                        type="text"
                                                        class="time-seconds-input input-basic edit-program-input a-text-bold-warm edit-schedule-item-time text-uppercase"
                                                        placeholder="00:00:00"></span>
                                            </div>
                            ...
                            <section class=" edit-program-data-container">
                                ...
                                <button
                                    class="a-btn-teal a-btn-basic-small text-normal a-text-MBlack float-right btn-actual d-flex align-items-center justify-content-center"><img
                                        src="./images/basic-icons/enter.svg" alt="" class="mr-2"> ACTUALIZAR</button>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4 edit-program-data-container">
                                        <div class="edit-data-container">
                                            ...
                                            <div
                                                class="mb-3 text-center edit-rectangle-small-container  backwhite py-3">
                    ...
                    <div class="dots-container mx-auto d-flex justify-content-between ">
                        ...
                        <div class="d-flex ">
                            ...
                            <img src="{{ asset('images/add-icon.svg') }}"
                                class="add-banner-image d-none cursor-pointer mb-3">
