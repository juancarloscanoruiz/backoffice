    ...
    <div class="contenedor-table mt-4 shadow" style="width:190%">
         <div class="contenedor-fila">
             <div class="contenedor-columna centro centro title-altauser">
              ...
              <div class="contenedor-columna centro centro title-altauser">
                 <span class="text-public"> Edición</span>
              </div>
              <div class="contenedor-columna centro centro title-altauser">
                 <span class="text-public"> Quién editó</span>
              </div>
              <div class="contenedor-columna centro centro title-altauser">
                 <span class="text-public"> Quién revisó</span>
              </div>
              <div class="contenedor-columna centro centro title-altauser">
                 <span class="text-public"> Vigencia</span>
              </div>
              <div class="contenedor-columna centro centro title-altauser">
                 <span class="text-public"> Comentarios</span>
              </div>
              <div class="contenedor-columna centro centro title-altauser">
                 <span class="text-public"> Ediciones</span>
              </div>
