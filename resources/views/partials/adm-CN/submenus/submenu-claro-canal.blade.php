...
<!--fin de claro canal-->
    ...
    <div class="modal fade modal-edit-program pr-0" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
                                ...
                                <div class="col-4">
                                    <div class="edit-data-container">
                                        ...
                                        <div class="mb-3 edit-rectangle-container p-3">
                                            <input type="text"
                                                class="w-100 input-basic edit-program-input a-text-bold-warm"
    ...
    <div class="modal fade modal-programming-carousel pr-0" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true" style="padding: 0px !important" >
        <div class="modal-dialog modal-dialog-centered m-0" role="document" style="max-width: 100%;">
          <div class="modal-content" >
            <div class="modal-body">
