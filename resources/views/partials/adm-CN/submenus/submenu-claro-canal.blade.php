                ...
                <div class="modal-body">
                    ...
                    <div class="programming-slider mx-auto">
                        ...
                        <div class="bor thumbnail-image-program position-relative h-100">
                            <input type="file" name="image_programming_1" id="image_background_1"
                                class="input-image-program d-none">
                        ...
                        <!--Slide-->
                        <div class="bor thumbnail-image-program position-relative h-100">
                            <input type="file" name="image_programming_2" id="image_programming_2"
                                class="input-image-program d-none">
                        ...
                        <!--Slide-->
                        <div class="bor thumbnail-image-program position-relative h-100">
                            <input type="file" name="image_programming_3" id="image_programming_3"
                                class="input-image-program d-none">
