<div class="modal modal-info-synopsis p-0 m-0" tabindex="-1" role="dialog" id="" aria-labelledby="exampleModalLongTitle"
    aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="container-image-synopsis mt-5 m-5" style="    border-radius: 0px;">
                    <div class="d-flex justify-content-around pt-4">
                        <div class="mt-2">
                            ...
                            <input type="text" name="duracion" id="duration-synopsis"
                                class=" input-information text-uppercase text-normal a-text-semibold-white  container-title-cinema"
                                placeholder="00" style="text-align: end;"> <span
                                class="a-text-bold-white text-normal">min</span>
                        </div>
                        <div class="mt-2">

                            <p class="a-text-bold-white text-plus mb-0">AÑO</p>
                            <input type="text" name="duracion" id="year-synopsis"
                                class=" centro input-information text-uppercase text-normal a-text-semibold-white  container-title-cinema"
                                placeholder="YYYY">
                        </div>
                    </div>
                    <div class="d-flex justify-content-around mt-4 pb-4">
                        <div class="mt-2">
                            ...
                            <input type="text" name="duracion" id="seasons-synopsis"
                                class=" centro input-information text-uppercase text-normal a-text-semibold-white  container-title-cinema"
                                placeholder="00">
                        </div>
                        <div class="mt-2">
                            ...
                            <input type="text" name="duracion" id="rating-synopsis"
                                class=" centro input-information text-uppercase text-normal a-text-semibold-white  container-title-cinema"
                                placeholder="YYYY">
                        </div>
                    </div>
                ...
                <div class="text-center  mb-3 d-flex justify-content-center pb-2 mt-4">
                    <button
                        ...
                        id="details-synopsis-modal-button" data-dismiss="modal">ACEPTAR</button>
