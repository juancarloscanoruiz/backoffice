<div class="modal modal-programming-sinopsis pr-0" id="modaledi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true" style="padding: 0px !important">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="programming-slider-sinopsis mx-auto">
                    ...
                    <span class="a-text-bold-warm text-plus mt-3 banner-text pl-4 pr-4 pt-2 pb-2">1191px X
                        471px</span>
            ...
            <div class="text-center mb-3 d-flex justify-content-center">
                <button class="button-modal-canal-claro edit-landing-modal-button d-flex  disabled-btn mr-3 text-uppercase  m-0 btn-landing a-btn-basic-small  text-uppercase text-plus a-text-bold-teal banner-slider-button" id="banner-sinopsis-modal-button">aceptar</button>
                <a href="#delete-info-sinopsis" role="button" class="d-flex m-0 text-none text-uppercase btn-landing a-btn-basic-small text-plus a-text-bold-teal cancel" data-toggle="modal">CANCELAR</a>
...
<div class=" modal  delete-info-sinopsis" data-backdrop-limit="1" id="delete-info-sinopsis" tabindex="-1" role="dialog" data-modal-parent="#modalbanner">
