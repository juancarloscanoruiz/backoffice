<div class="modal modal-synopsis-images-container p-0 m-0" tabindex="-1" role="dialog" id="modalpromos">
                ...
                <p class="text-normal d-flex ml-3 text-center a-text-black-brown-two pt-3">CARGAR IMÁGENES EN FORMATO
                    ...
                    <form>
                        ...
                        <div class= "d-flex justify-content-around">
                                     <div class="mt-3 d-flex mr-5">
                                     <p class="text-normal a-text-bold-greyish-brown-two">Nombre_Sinópsis_CanalClaro_20200709.jpg</p>
                                    </div>
                                    <div class="mt-3 d-flex mr-5">
                                    <p class="text-normal a-text-bold-greyish-brown-two">Nombre_Sinópsis_CanalClaro_20200709.jpg</p>
                                    </div>
