<div class="modal modal-synopsis-images-container modal-landing-synopsis p-0 m-0" tabindex="-1" role="dialog"
    id="modalpromos">
                    ...
                    <div class="d-flex justify-content-around  container-image-synopsis col-12 mb-3 mt-5">
                        ...
                        <div class="d-flex justify-content-center align-items-center align-content-center mt-3">
                            ...
                            <div class="centro position-relative logo-lading-container mb-3">
                                ...
                                <form>
                                    <div
                                        class="d-flex justify-content-around  container-image-synopsis col-12 mb-3 mt-5">

                                        <div
                                            class="d-flex justify-content-center align-items-center align-content-center mt-3">
    ...
    <div class=" modal  delete-info-synopsis" data-backdrop-limit="1" id="delete-info-synopsis" tabindex="-1"
