<div class="modal modal-titles p-0 m-0" tabindex="-1" role="dialog" id="modaltitles">
    <div class="modal-dialog modal-lg modal-dialog-centered " role="document">
        <div class="modal-content align-item-center centro w-100">
            <div class="modal-body">
                ...
                <div class="container-promotitle  mt-4 m-5">
                    <div>
                        <input type="text" name="links" id="hoy-channel"
                            class="section-landing-title text-uppercase a-text-black-bright-cyan url-input p-4 pt-5 pb-5 h3 m-2 container-width container-title concert-input-title"
                            placeholder="TÍTULO">
                    </div>
                    <div>

                        <input type="text" name="links" id="hoy-channel"
                            class="section-landing-subtitle text-uppercase url-input p-3 a-text-bold-white container-width m-2 container-title text-normal  pl-4 hoy-en"
