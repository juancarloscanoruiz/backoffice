      ...
      <div class="modal-body">
         ...
         <div class="container-promotitle  mt-4 m-5">
             ...
             <input type="text" name="links" id="hoy-channel"
                                            class="url-input p-4 pt-5 pb-5 h3 m-2 container-width container-title  concert-input-title" placeholder=" TÍTULO" >
             </div>
             <div>

             <input type="text" name="links" id="hoy-channel"
                                            class="url-input p-3 container-width m-2 container-title text-normal  pl-4 hoy-en" placeholder=" SUBTITULO" >
            </div>
