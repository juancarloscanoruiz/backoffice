<div class="modal modal-programming-carousel-concert pr-0" id="modaledi" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="dots-container mx-auto d-flex justify-content-between">
                    <div class="d-flex">
                        ...
                        <img src="{{ asset('images/add-icon.svg') }}"
                            class="add-banner-image-concert cursor-pointer mb-3">
                    </div>
                    <!--Calendar-->
                ...
                <div class="text-center mb-3 d-flex justify-content-center">
                    <button
                        class="edit-landing-modal-button button-modal-concert-channel banner-slider-button d-flex mr-3 text-uppercase  m-0 btn-grilla a-btn-basic-small btn-grilla a-btn-basic-small text-uppercase a-text-MBlack text-plus"
                        id="image-programming-button" landin="canal claro" data-dismiss="modal">aceptar</button>
                    <a href="#delete-concert-button" role="button"
...
<div class="modal delete-info-encabezado" data-backdrop-limit="1" id="delete-concert-button" tabindex="-1" role="dialog"
