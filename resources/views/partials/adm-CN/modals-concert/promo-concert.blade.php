        ...
        <div class="modal-content  ">
            <div class="modal-body pl-5 ml-3 ">
                ...
                <div class="mt-5 d-flex ">
                    ...
                    <input type="text" name="links" id="link-promo-concert"
            ...
            <div class="text-center  mb-4 d-flex justify-content-center pb-2 mt-4">
                <button
                    ...
                    id="url-promo-concert-button" data-dismiss="modal">ACEPTAR</button>
        ...
        <div class="modal-content  ">
            ...
            <div class="text-center mb-5 mt-4 pt-3 pb-4">
                ...
                <button type="button" data-target="#delete-info-claro"
                    class="a-btn-basic-small a-btn-tomato  a-text-MBlack  h1" data-dismiss="modal"
