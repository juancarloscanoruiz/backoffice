            ...
            <div class="modal-body ">
                ...
                <div class="container-promo p-3  mt-4">
                    ...
                    <div class="justify-content-around position-absolute d-flex p-5  "
                        ...
                        <input type="file" name="" id="video-promo-file" class="d-none file-video" accept="video/*">
                        <label for="video-promo-file"
                        ...
                        <label for="url-promo"
                            ...
                            <a href="#url-promo" role="button" data-toggle="modal" class="link-url-modal">
                    ...
                    <div class="position-relative" id="concert-promo-container">
                        <video width="472" class="w-100 h-100" id="video-promo-concert" controls muted autoplay>
