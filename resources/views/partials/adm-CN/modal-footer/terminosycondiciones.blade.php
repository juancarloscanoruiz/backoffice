<div id="modal-terminos-footer" class="modal" style="overflow: auto; z-index: 9998;">
    <div class="modal-dialog-centered modal-dialog modal-terminos-footer-width">
        <div class="modal-content modal-terminos-footer">
            <!-- TEXTO -->
            <h3 class="h3 text-center a-text-black-brown-two pt-2">FOOTER - TERMINOS Y CONDICIONES</h3>
            <hr class="hr">
                ...
                <div class="row">
                    <div class="col-12 p-0">
                        ...
                        <div class="txa-tercon">
                            ...
                            <textarea class="footer-textarea-ter a-text-black-brown-two mt-3" placeholder="Texto"></textarea>
                        </div>
                    </div>
                </div>
            </div>
