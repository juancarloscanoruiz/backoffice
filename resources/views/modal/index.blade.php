...
@section('content')
    ...
    <body class="bg-dark">
        <!-- Modal 1 -->
        <div id="modal-encabezado" class="modal-encabezado">
        ...
        <!-- Modal 2 -->
        <div id="modal-url" class="modal-url d-none">
            ...
            <div class="modal-footer">
                <div class="m-auto">
                    <button class="a-btn-basic-small a-button-outline-teal a-text-bold-teal text-plus"
                        style="opacity: .3;">ACEPTAR</button>
