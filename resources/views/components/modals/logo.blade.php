                ...
                <div class="row">
                    <div class="col-12 col-md-6 p-0">
                        ...
                        <div id="dinamic_width" class="home-logo-container position-relative p-3">
                            ...
                            <label for="logo_home" class="add-file positiion-relative">
                                <img id="camera" class="d-block mx-auto cursor-pointer mb-2"
                                    src="./images/basic-icons/camara.svg" alt="add-photo" />
                                <p class="text-center a-text-bold-warm text-plus">350px X 73px</p>
                            </label>
                    ...
                    <div class="col-12 col-md-6 p-0">
                        <div class="text-right m-0">
                            ...
                            <div class="mt-4">
                                <img class="cursor-pointer modal_url" id="modal_url" src="./images/basic-icons/link.svg"
                                    style="width: 40px;">
                                <input id="inp_url" class="inp_url input-url width-url a-text-bold-warm text-normal"
                    ...
                    <!-- SUBTITULO -->
                    <input id="inp_canales_subtitulo" class="a-text-bold-coolgray ipt-home-canales  text-uppercase"
                        placeholder="SUBTITULO" type="text">
                </div>
            </div>
            <!-- BOTONES -->
            <div class="content mt-4">
                <div class="d-flex justify-content-center">
                    <button id="acepta_canales_home"
