<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="modal" id="show-banner" style="overflow: auto">
                <div class="modal-dialog modal-dialog-centered" style="max-width: 1500px;">
                    <div class="modal-content py-4 border-0" style="border-radius: 0;">
                        <h2 class="h2 text-center a-text-black-brown-two">BANNER SINOPSIS - CARRUSEL</h2>
                        <hr class="hr col-11" />
