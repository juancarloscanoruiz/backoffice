<div class="modal" data-backdrop-limit="1" id="delete-info" style="overflow: auto; z-index: 9999;">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="text-center mb-5 mt-4 pt-3 pb-4">
                <button type="button" class="a-btn-basic-small a-btn-border-tomato mr-3 a-text-bold-tomato h1 close-all-modal" data-dismiss="modal" id="close-modal">ACEPTAR</button>
