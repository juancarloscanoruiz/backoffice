<div class="modal pr-0  modal-edit-program-carrusel" id="modaledicarrusel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true" style="overflow: auto;">
    <div class="modal-dialog modal-dialog-centered m-0" role="document" style="max-width: 100%">
        <div class="modal-content" style="max-width: 1350px;margin: auto;">
                                ...
                                <div class="row">
                                        ...
                                        <div class="edit-data-container h-100">
                                            ...
                                            <div>
                                                ...
                                                <div class="mb-4 text-center edit-rectangle-small-container backwhite py-2 align-items-center">
                                                    ...
                                                    <span class="a-text-bold-warm pr-2">Fin: <input type="text" class="input-basic edit-program-input a-text-bold-warm edit-program-attribute-text schedule-date-input edit-landing-date-end" key="in_landing_expiration" placeholder="00-00-0000"></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="text-center edit-rectangle-small-container backwhite py-2 align-items-center">
                                                ...
                                                <span class="a-text-bold-warm pr-2">Fin: <input type="text" class="time-seconds-input input-basic edit-program-input edit-program-attribute-text a-text-bold-warm text-uppercase edit-landing-time-end" key="in_landing_expiration" placeholder="00:00:00"></span>
                                            </div>
                                        </div>
                                    </div>
                                    <!--Home-->
                                    <div class="col-4 edit-program-data-container edit-data-container-large">
                                        <div class="edit-data-container h-100">
                                            ...
                                            <div class="text-center edit-rectangle-small-container backwhite py-2 align-items-center">
                                                <img src="{{ asset('images/reloj.svg') }}" alt="" class="mr-3">
                                                <span class="a-text-bold-warm pr-2">Fin: <input type="text" class="time-seconds-input input-basic edit-program-input a-text-bold-warm text-uppercase edit-home-time-end" placeholder="00:00:00"></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-4 edit-program-data-container edit-data-container-large">
                                        <div class="edit-data-container h-100">
                                            ...
                                            <div class="text-center edit-rectangle-small-container backwhite d-flex align-content-center justify-content-center py-2">
                                                <img src="{{ asset('images/reloj.svg') }}" alt="" class="mr-3">
                                                <span class="a-text-bold-warm mt-3"><input type="text" class="time-seconds-input input-basic edit-program-input a-text-bold-warm edit-schedule-item-time text-uppercase" placeholder="00:00:00"></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4 edit-program-data-container edit-data-container-large">
                                        <div class="edit-data-container h-100">
                                            ...
                                            <!--Switch-->
                                            <div class="d-flex align-items-center mb-3">
                                                <input type="radio" id="yes-landing-carrusel" value="3" class="edit-switch-landing edit-landing-yes" key="in_landing" />
                                                <label for="yes-landing-carrusel" id="siestado-landing" class="mb-0 si-estilo cursor-pointer switch-label">
                                                    Sí</label>
                                                <input type="radio" id="no-landing-carrusel" value="0" class="edit-switch-landing switch-table-edit edit-landing-no" checked />
                                                <label for="no-landing-carrusel" id="noestado-landing" class="mb-0 no-estilo cursor-pointer switch-label">
                                                    No</label>
                                            </div>
                                            <!--Inputs radio-->
                                            <div class="d-flex align-items-center mb-3">
