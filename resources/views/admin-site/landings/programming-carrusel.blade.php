...
@section('content')
    ...
    <body>
        ...
        <!--Form-->
        <form action="{{ route('updateProgrammingSlider') }}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            <!--Slider pagination-->
            <div class="dots-container mx-auto d-flex justify-content-between">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <input class="d-none" name="date" type="text" id="programming-carrusel-calendar">
