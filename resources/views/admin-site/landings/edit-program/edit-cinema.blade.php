...
<div class="modal pr-0  modal-edit-program" id="modaledi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true" style="overflow: auto;     display: contents;">
    <div class="modal-dialog modal-dialog-centered m-0" role="document" style="max-width: 100%">
        <div class="modal-content">
            <div class="modal-body pt-0">
                <h2 class="edit-program-modal-title h2 text-center a-text-black-brown-two pt-3">HOME - CLARO CINEMA -
                    CARRUSEL PROMO </h2>
                ...
                <div class="col-11 mx-auto">
                    ...
                    <!--  <section class="col-8 mx-auto">
                            <h3 class="h3 a-text-semibold-brownish-grey-three text-uppercase mb-5 mt-6 slider-calendar-current-date"
                                        ...
                                        <div class="edit-data-container h-100">
                                            ...
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <label for="yes-landing" id="siestado-landing" class="mb-0 si-estilo cursor-pointer switch-label">
                                                    Sí</label>
                                                <input type="radio" name="sino-landing" id="no-landing" value="0" class="edit-switch-landing switch-table-edit edit-landing-no" key="in_landing" checked />
                        ...
                        <div class="col-4 m-2">
                            <section class="mb-3">
                                <div class="row">
                                    <div class="w-100 edit-program-data-container ">
                                        <div class="edit-data-container h-100">
                                            <p class="edit-date-time-title1 text-plus text-plus text-uppercase a-text-bold-coolgray">
                                                Schedule Item Date time
                                            </p>
                                            <div>
                                                <p class="mb-3 pb-1 text-plus a-text-medium-coolgray text-uppercase">
                                                    Fecha</p>
                            ...
                            <div class="col-4 edit-program-data-container position-relative" id="edit-genre-container">
                                <div class="edit-data-container">
                                    ...
                                    <div class="mb-3 edit-rectangle-container backwhite ">
                                        <select class="listcinema mb-0 a-text-regular-brownishtwo text-normal  input-basic show-tick" id="edit-program-genres" title="Genere list" multiple data-live-search="true" data-live-search-placeholder="Buscar" data-header="Program List" data-dropup-auto="false">
