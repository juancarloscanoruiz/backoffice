...
<div class="modal pr-0  modal-edit-program" id="modaledi" tabindex="-1" role="dialog"
                                        ...
                                        <div class="edit-data-container h-100">
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex justify-content-around">
                                                    <div
                                                        class="mb-3 text-center edit-rectangle-small-container backwhite py-3 mr-3">
                                                    ...
                                                    <div
                                                        class="mb-4 text-center edit-rectangle-small-container backwhite py-3">
                                        ...
                                        <div class="edit-data-container h-100">
                                            ...
                                            <div>
                                                <p class="mb-3 pb-1 text-plus a-text-medium-coolgray text-uppercase">
                                                    Fecha</p>
                                                <div
                                                    class="text-center edit-rectangle-small-container backwhite py-2 d-flex align-content-center justify-content-center mb-2">
                                            ...
                                            <div
                                                class="text-center edit-rectangle-small-container backwhite d-flex align-content-center justify-content-center mb-3 py-2">
                        ...
                        <div class="col-4 mb-4 mt-2">
                            ...
                            <div class="cinema-image-slider mx-auto mb-0">
                                ...
                                <div class="bor thumbnail-image-program position-relative h-100">
                                    <input type="file" name="image_background_1" id="image_background_1"
                                    ...
                                    <label for="edit-image-horizontal"
                                        ...
                                        <label for="image_background_1"
                                            ...
                                            <img src="{{ asset('/images/synopsis/image-vertical.svg') }}"
                                ...
                                <div class="bor thumbnail-image-program position-relative h-100">
                                    <input type="file" name="image_background_2" id="image_background_2"
                                        class="input-image-program d-none">
                                ...
                                <div class="bor thumbnail-image-program position-relative h-100">
                                    <input type="file" name="image_background_3" id="image_background_3"
                                        class="input-image-program d-none">
                            ...
                            <div class="col-4 edit-program-data-container position-relative" id="edit-genre-container">
                                <div class="edit-data-container">
                                    ...
                                    <div class="mb-3 edit-rectangle-container backwhite ">
                                        <select
                                            class="listcinema mb-0 a-text-regular-brownishtwo text-normal  input-basic show-tick"
                    ...
                    <section class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-4 edit-program-data-container">
                                <div class="edit-data-container h-100">
                                    <p style="margin-bottom: 43px"
                                        class="text-plus text-uppercase a-text-bold-brown-two">Schedule item log
                                        date
                                    </p>
                            ...
                            <div class="col-4 edit-program-data-container">
                                <div class="edit-data-container h-100">
                                    <p style="margin-bottom: 43px"
                                        class="text-plus text-uppercase a-text-bold-brown-two pb-4">Schedule item log
                                        time (gmt)
                                    </p>
                            ...
                            <div class="col-4 edit-program-data-container">
                                <div class="edit-data-container h-100">
                                    <p class=" text-plus text-uppercase a-text-bold-brown-two "
                                        style="margin-bottom: 43px">estimated schedule item duration
                                    </p>
                                    <p class="a-text-medium-brown-two text-plus text-uppercase pt-4">HORA</p>
                                    <div
                                        class="mb-3 text-center edit-rectangle-small-container  backwhite py-3 d-flex align-items-center justify-content-center">
