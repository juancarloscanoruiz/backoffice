            ...
            <div class="row no-gutters">
                <ul class="tv-list-programming col-md-9 mt-5 mb-5">
                    <div class="col-md centro no-gap border-r d-flex justify-content-center">
                        <li rel="claro-networks-programing" class="list-channel-item px-5 py-4 list-channel-active d-flex align-content-center">
                            <img class="claro-nav-image" src="{{ asset('/images/home/claro-logo.svg') }}" alt="" id="icon_canal_claro" style="width: 100px" />
                        </li>
                    </div>
                    <div class="col-md centro no-gap border-r d-flex justify-content-center">
                        <li rel="claro-canal-programing" class="px-5 py-4 list-channel-item d-flex align-content-center">
