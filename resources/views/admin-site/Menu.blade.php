    ...
    @include('partials.headers.headerPrograGeneral')
        ...
        <nav class="d-flex col-xl-12 navbar-expand-sm justify-content-center position-nav pt-4">
            <ul class="d-flex justify-content-center navbar-nav">
                ...
                <li class="nav-item br-r">
                    <button id="grilla-claro-cinema-button" class="btn-menu-all  a-btn-basic-medium a-text-bold-brown-two text-normal bn-nav">Claro Cinema</button>
                </li>
                <li class="nav-item br-r">
                    <button class="btn-menu-inac a-btn-basic-medium text-normal a-text-bold-brown-two ">Nuesta Visión*</button>
                </li>
                <li class="nav-item br-r ">
                    <button class="btn-menu-inac  a-btn-basic-medium  text-normal a-text-bold-brown-two">Claro Sport*</button>
                </li>
                <li class="nav-item ">
                    <button id="grilla-home-button" class="btn-menu-all a-btn-basic-medium  a-text-bold-brown-two text-normal bn-nav"> Home</button>
                </li>
            </ul>
        </nav>
