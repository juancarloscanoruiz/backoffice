...
<body>
    ...
    @include('partials.headers.headerPrograGeneral')
        ...
        <span class="text-titulo-rojo text-uppercase">{{$respuesta->data->first_day}}</span><span class="text-titulo"> AL </span> <span class="text-titulo-rojo text-uppercase">{{$respuesta->data->last_day}}</span>
        </div>
