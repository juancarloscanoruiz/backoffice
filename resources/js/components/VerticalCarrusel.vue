<template>
<div>
    <div id="modal-vertical-carrusel" class="modal" style="overflow: auto;">
                            ...
                            <div class="row">
                                <div class="col-12 p-0">
                                    ...
                                    <div class="float-right">
                                        <div class="d-flex">
                                            <div class="position-relative carrusel1-slider-dots1 slick-dots mb-5"></div>
                                            <!-- <img src="images/add-icon.svg" class="add-programming-image mb-3 cursor-pointer"> -->
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <section class="d-flex justify-content-between">
                                                <div class="col-5">
                                                    ...
                                                    <div class="state-container py-2 d-flex align-items-center justify-content-center">
                                                        ...
                                                        <p class="mb-0 ml-3 a-text-bold-teal">{{data.status}}</p>
                                                    </div>
                                                </div>
                                                <div class="col-5">
                                                    ...
                                                    <div class="py-2 alert-container d-flex align-items-center justify-content-center">
                                                        ...
                                                        <p class="mb-0 ml-3 a-text-bold-orange">{{data.alert}}</p>
                                                    </div>
                                                </div>
                                            </section>
                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6 edit-program-data-container">
                                                            <div class="edit-data-container">
                                                                ...
                                                                <!--Switch-->
                                                                <div class="d-flex align-items-center mb-3 pl-5" v-if="data.chapter.in_landing == 1">
                                                                    <input :name="'yes-landing-carrusel-'+data.chapter.id" type="radio" :id="'yes-landing-carrusel-'+data.chapter.id" value="1" class="edit-switch-landing edit-landing-yes" checked />
                                                                    <label :for="'yes-landing-carrusel-'+data.chapter.id" id="siestado-landing" class="mb-0 si-estilo cursor-pointer switch-label" v-on:click="inLandingBegin(data.chapter.id, 'in_landing', '1')">Sí</label>
                                                                    <input type="radio" :name="'yes-landing-carrusel-'+data.chapter.id" :id="'no-landing-carrusel-'+data.chapter.id" value="0" class="edit-switch-landing edit-program-switch edit-landing-no">
                                                                    <label :for="'no-landing-carrusel-'+data.chapter.id" id="noestado-landing" class="mb-0 no-estilo cursor-pointer switch-label" v-on:click="inLandingBegin(data.chapter.id, 'in_landing', '0')">No</label>
                                                                </div>
                                                                <div class="d-flex align-items-center mb-3 pl-5" v-if="data.chapter.in_landing == 0">
                                                                    <input :name="'yes-landing-carrusel-'+data.chapter.id" type="radio" :id="'yes-landing-carrusel-'+data.chapter.id" value="1" class="edit-switch-landing edit-landing-yes" />
                                                                    <label :for="'yes-landing-carrusel-'+data.chapter.id" id="siestado-landing" class="mb-0 si-estilo cursor-pointer switch-label" v-on:click="inLandingBegin(data.chapter.id, 'in_landing', '1')">Sí</label>
                                                                    <input type="radio" :name="'yes-landing-carrusel-'+data.chapter.id" :id="'no-landing-carrusel-'+data.chapter.id" value="0" class="edit-switch-landing edit-program-switch edit-landing-no" checked>
                                                                    <label :for="'no-landing-carrusel-'+data.chapter.id" id="noestado-landing" class="mb-0 no-estilo cursor-pointer switch-label" v-on:click="inLandingBegin(data.chapter.id, 'in_landing', '0')">No</label>
                                                                </div>
                                                                <!--Inputs radio-->
                                                                        ...
                                                                        <div class="col-6 mb-4">
                                                                            <div class="text-center edit-rectangle-max-container py-2 d-flex align-content-center justify-content-center">
                                                                                ...
                                                                                <span class="a-text-bold-warm mt-3">
                                                                                    <input type="text" class="input-basic edit-program-input a-text-bold-warm schedule-date-input edit-schedule-date in_landing_begin" placeholder="00-00-0000" v-on:keyup.enter="in_begin(data.chapter.id, 'in_landing_begin')" :value="data.chapter.in_landing_begin"></span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-6">
                                                                            <div class="text-center edit-rectangle-max-container py-2 d-flex align-content-center justify-content-center">
                                                                                ...
                                                                                <img src="/images/calendario.svg" alt="" class="mr-3">
                                                                                <span class="a-text-bold-warm mt-3">
                                                                                    <input type=" text" class="input-basic edit-program-input a-text-bold-warm schedule-date-input edit-schedule-date in_landing_expiration" placeholder="00-00-0000" v-on:keyup.enter="in_begin(data.chapter.id, 'in_landing_expiration')" :value="data.chapter.in_landing_expiration"></span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-6">
                                                                            <div class="text-center edit-rectangle-max-container py-2 d-flex align-content-center justify-content-center">
                                                                                ...
                                                                                <span class="a-text-bold-warm mt-3">
                                                                                    <input type="text" class="input-basic edit-program-input a-text-bold-warm schedule-time-input edit-schedule-date in_landing_begin_hour" placeholder="00:00:00" v-on:keyup.enter="in_begin(data.chapter.id, 'in_landing_begin')" :value="data.chapter.in_landing_begin"></span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-6">
                                                                            <div class="text-center edit-rectangle-max-container py-2 d-flex align-content-center justify-content-center">
                                                                                ...
                                                                                <img src="/images/reloj.svg" alt="" class="mr-3">
                                                                                <span class="a-text-bold-warm mt-3">
                                                                                    <input type="text" class="input-basic edit-program-input a-text-bold-warm schedule-time-input edit-schedule-date in_landing_expiration_hour" placeholder="00:00:00" v-on:keyup.enter="in_begin(data.chapter.id, 'in_landing_expiration')" :value="data.chapter.in_landing_expiration"></span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-6 mb-4">
                                                                        ...
                                                                        <div class="text-center edit-rectangle-max-container py-2 d-flex align-content-center justify-content-center" style="margin-bottom: 99px">
                                                                            ...
                                                                            <span class="a-text-bold-warm mt-2">
                                                                                <input type=" text" class="input-basic edit-program-input a-text-bold-warm schedule-date-input edit-schedule-date day" placeholder="00-00-0000" :value="data.chapter.day" v-on:keyup.enter="in_begin_hour(data.chapter.id, 'day')"></span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <p class="mb-3 text-plus a-text-medium-coolgray text-uppercase">Hora</p>
                                                                        <div class="text-center edit-rectangle-max-container d-flex align-content-center justify-content-center py-2">
                                                                            <img src="/images/reloj.svg" alt="" class="mr-3">
                                                                            <span class="a-text-bold-warm mt-2"><input type="text" class="time-seconds-input input-basic edit-program-input a-text-bold-warm edit-schedule-item-time text-uppercase hour" placeholder="00:00:00" :value="data.chapter.hour" v-on:keyup.enter="in_begin_hour(data.chapter.id, 'hour')"></span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="col-4 p-0" id="img_carrusel_home">
                                                    <div>
                                                        ...
                                                        <div class="position-relative text-center">
                                                            <img class="img-back-modal img-carrusel-home" id="img-carrusel-home" :src="data.chapter.program.thumbnail_list_vertical">
                                                        </div>
                                                        <!-- BTN ICONOS -->
...
export default {
    ...
    methods: {
        inLandingBegin: function (id, key, value) {
        ...
        in_begin: function (id, key) {
            let v1 = $("." + key).val();
            let v2 = $("." + key + "_hour").val();
            let value = '';
            this.value = v1;
            this.value = this.value.split('-').reverse().join('-')
            if (v2 == '') {
                value = this.value + ' 00:00';
            } else {
                value = this.value + ' ' + v2;
            }
            store.commit('updateData', {
