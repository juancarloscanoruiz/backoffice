...
import { previewImage, modalClose, dateCalendar, modalUrlClose, modalUrl, closeModals, closeModalUrl, evnUrl, evnSinopsis, synopsisCalendarItem, evnProgramacion } from './events/events'
import { setBanner, setLogo, setBannerProgramacion, setLogosProgramacion, setHeaderCanalClaro, setTituloCanalClaro } from './methods'
...
function getProgramChapter(res, first_day_calendar, last_day_calendar) {
    console.log(res)
    let last_day = last_day_calendar[2];
    let last_month = last_day_calendar[1];
    let last_year = last_day_calendar[0];

    let slick = $('.slick-calendarioChapter');
    let slickMonth = $('.monthSliderCalendarChapter');

    let index = slickCalendar((last_month - 1), last_day, slick, slickMonth)
    slickShowCalendar(slick, index)

    $('#show-chapter').modal('show');
    $(".loader-view-container").remove();
}
// let landing;
// let lang;
...
export {
    getBanner, getLogos, getProgramChapter
    // getLogosProgramacion, getSynopsisTable, getBannerSinopsis, getBannerCanalClaro, getHeaderCanalClaro, getProgramacionCanalClaro, getTitleCanalClaro, updateProgramacion, getPromoCanalClaro, updateSinopsis
}
